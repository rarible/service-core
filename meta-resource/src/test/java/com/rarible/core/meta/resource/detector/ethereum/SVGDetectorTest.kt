...
class SVGDetectorTest {
    ...
    private val svgUrl = "https://some.data.com/data:image/svg+xml;utf8,<svg%20class='nft'><rect%20class='c217'%20x='10'%20y='12'%20width='2'%20height='1' fill:%23AAAAAA/></svg>"
    ...
    fun `can decode svg images`() {
        val svg = String(Files.readAllBytes(
            Paths.get(this::class.java.getResource("/meta/resource/detector/ethereum/test.svg").toURI())
        ));
