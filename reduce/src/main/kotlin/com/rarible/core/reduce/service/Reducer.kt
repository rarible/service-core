...
interface Reducer<Event : ReduceEvent<Mark>, Mark : Comparable<Mark>, Data, Key : DataKey> {
    fun getDataKeyFromEvent(event: Event): Key

    fun getInitialData(key: Key): Data

    suspend fun reduce(initial: Data, events: Flow<Event>): ReduceSnapshot<Data, Mark>
}